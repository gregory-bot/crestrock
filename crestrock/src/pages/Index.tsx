...
const HERO_URL = 'https://i.pinimg.com/736x/5b/d0/da/5bd0dabc6c55581d49d96453a06c87c9.jpg';
...
// Add these carousel images
const CAROUSEL_IMAGE_1 = 'https://i.pinimg.com/1200x/a0/c0/1d/a0c01d753513b145a29d4be87bd9aa43.jpg';
const CAROUSEL_IMAGE_2 = 'https://i.pinimg.com/1200x/9d/a0/d6/9da0d6714505028b02328c203bf44845.jpg';
const CAROUSEL_IMAGE_3 = 'https://i.pinimg.com/1200x/37/af/07/37af0765eeb3d0dde512ea8fd49807d1.jpg';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-black max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="w-44 sm:w-auto bg-blue-600 hover:opacity-90 transition-spring hover:scale-105 shadow-large"
                ...
                <Button
                  ...
                  asChild
                >
                  <Link to="/about">Learn More <ArrowRight className="w-5 h-5 ml-2" />
                  </Link>
                </Button>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="w-full h-56 sm:h-72 md:h-[360px] lg:h-[380px] rounded-2xl overflow-hidden shadow-large">
                <img
                  src={HERO_URL}
                  alt="Hero phones"
      ...
      <section id="products" className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-blue-500 bg-clip-text text-transparent">
              Our Collection
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-5">curated selection of laptops.</p>
                  <Link to="/category/laptops">
                    <Button 
                      size="sm" 
                      className="mx-auto px-6 py-2 bg-blue-600 hover:opacity-90 transition-all duration-300 group-hover:scale-105"
                    >
                      View more
              ...
              <div className="group bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-5">Browse the latest iPhone.</p>
                  <Link to="/category/iphones">
                    <Button 
                      size="sm" 
                      className="mx-auto px-6 py-2 bg-blue-500 hover:opacity-90 transition-all duration-300 group-hover:scale-105"
                    >
                      View more
                      <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
                    </Button>
      ...
      <section className="py-16 bg-gradient-to-r from-primary/5 to-accent/5">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center text-slate-800">
            Why Gadgets by Crestrock?
          </h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            {/* Left: Image carousel with consistent, professional sizing */}
            <div>
              <div className="rounded-2xl overflow-hidden shadow-lg bg-white">
                <Carousel
                  opts={{ 
                    loop: true,
                    autoplay: {
                      delay: 10000, // Auto-transition every 10s
                  ...
                  <div className="space-y-2">
                    <Collapsible>
                      <CollapsibleTrigger asChild>
                        <button className="w-full flex justify-between items-center p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                          <span className="text-left font-medium">Do your products come with warranty?</span>
                    ...
                    <Collapsible>
                      <CollapsibleTrigger asChild>
                        <button className="w-full flex justify-between items-center p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                          <span className="text-left font-medium">How long does delivery take?</span>
                          <span className="text-sm text-muted-foreground">+</span>
                        </button>
                      </CollapsibleTrigger>
                      <CollapsibleContent>
                    ...
                    <Collapsible>
                      <CollapsibleTrigger asChild>
                        <button className="w-full flex justify-between items-center p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                          <span className="text-left font-medium">Can I return a device?</span>
                          <span className="text-sm text-muted-foreground">+</span>
                        </button>
                      </CollapsibleTrigger>
                      <CollapsibleContent>
                    ...
                    <Collapsible>
                      <CollapsibleTrigger asChild>
                        <button className="w-full flex justify-between items-center p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                          <span className="text-left font-medium">Do you offer trade-ins?</span>
                          <span className="text-sm text-muted-foreground">+</span>
                        </button>
                      </CollapsibleTrigger>
                      <CollapsibleContent>
                    ...
                    <Collapsible>
                      <CollapsibleTrigger asChild>
                        <button className="w-full flex justify-between items-center p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors">
                          <span className="text-left font-medium">How can I pay?</span>
                          <span className="text-sm text-muted-foreground">+</span>
                        </button>
                      </CollapsibleTrigger>
                      <CollapsibleContent>
