...
const Contact = () => {
  ...
  const sendFormToWhatsApp = () => {
    ...
    const url = `https://wa.me/254742312545?text=${encodeURIComponent(body)}`;
    window.open(url, '_blank');
  };

  const handleQuickWhatsApp = () => {
    const body = "Hi! I'd like to get more information about your products and services.";
    const whatsappUrl = `https://wa.me/254742312545?text=${encodeURIComponent(body)}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-lg">+254742312545</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-lg">info@shop.gadgets.crestrock.ltd</p>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center text-sm text-muted-foreground">
              Prefer calling? <a href="tel:+254742312545" className="text-primary underline">+254742312545</a>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span>+254723555861</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-primary" />
                    <span>info@shop.gadgets.crestrock.ltd</span>
                  </div>
                </div>
                <div className="mt-4">
